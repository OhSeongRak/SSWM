...
const StudyRoomMember = () => {
  ...
  const closeModalEvent = () => {
    ...
    axios.put(`{REACT_APP_BASE_URL}/api/studyrooms/${studyroomId}/leave`,{},{
      headers:{
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // dailylog 생성
        await axios.post(`{REACT_APP_BASE_URL}/api/user-logs/${studyroomId}`, {}, {
          headers: {
            Authorization: accessToken,
          },
        });
        ...
        // 스터디룸 조회
        const studyroomResponse = await axios.get(`{REACT_APP_BASE_URL}/api/studyrooms/${studyroomId}`, {
          headers: {
            Authorization: accessToken,
          },
        });
        ...
        axios.get(`{REACT_APP_BASE_URL}/api/studyrooms/${studyroomId}/isHost`, {
          headers: {
            Authorization: accessToken,
          },
        })
